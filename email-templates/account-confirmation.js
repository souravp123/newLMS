...
export const confirmEmailAddress = async (user) => {
    const data = {
        ...
        subject: "Verify Ivy Dude Account | OTP",
        html: ` 
        <!DOCTYPE html>
        ...
        <head>
            ...
            <title>Verify Ivy Dude Account | OTP</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="text" style="padding: 0 2.5em; text-align: left;">
                                    ...
                                    <p>Thanks for registering on the Ivy Dude! Verify your email address and activate your account using this OTP now!</p>
              ...
              <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              ...
                              <p style="text-align: center; margin-bottom: 0; margin-top: 5px">
                                  <a href="http://ivydude.com/" target="_blank" style="color: #3056de">www.ivydude.com</a>
                              </p>
                              </td>
                            </tr>
                          </table>
                ...
                <tr>
                  <td class="bg_light" style="text-align: center;">
                    <p>&copy;2022 Ivy Dude Support</p>
                  </td>
                </tr>
              </table>
