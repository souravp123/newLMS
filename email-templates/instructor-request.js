...
export const instructorRequest = async (
    ...
    const data = {
        to: admin_email,
        from: "Ivy Dude Online Courses <info@ivydude.com>",
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: left;">
                                    ...
                                    <p>Instructor experience: ${instructor_experience}</p>
                                    // <p>Instructor qualifications: ${instructor_qualifications}</p>
                                    ...
                                    <p>
                                        Regards, <br />
                                        Ivy Dude Support Team <br />
                                        All Rights Reserved by ivydude.com
                                    </p>
                                </div>
                            </td>
                        </tr>
