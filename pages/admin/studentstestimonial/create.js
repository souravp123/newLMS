...
const Index = ({ user }) => {
	...
	React.useEffect(() => {
		const isTestimonial = Object.entries(testimonial)
        .filter(([key, value]) => key !== 'role') // Exclude 'role' field
        .every(([key, value]) => Boolean(value));
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const { name, designation, description, role } = testimonial;
			const payload = {
				image_url: photo,
				name,
				role:"student",
			...
			router.push("/admin/studentstestimonial");
		} catch (err) {
			let {
				response: {
					data: { message },
						...
						<div className="col-lg-9 col-md-8">
							<div className="main-content-box">
								...
								<ul className="nav-style1">
									<li>
										<Link href="/admin/studentstestimonial/">
											<a>Students Testimonials</a>
										</Link>
									</li>
									<li>
										<Link href="/admin/studentstestimonial/create/">
								...
								<form onSubmit={handleSubmit}>
									<div className="row">
										<div className="col-md-12">
											<div className="form-group">
												<label className="form-label fw-semibold">
													Image<span style={{color:"red",fontSize:"1.3rem"}}>*</span>
												</label>
												<input
													type="file"
										...
										<div className="col-md-12">
											<div className="form-group">
												<label className="form-label fw-semibold">
													Name<span style={{color:"red",fontSize:"1.3rem"}}>*</span>
												</label>
												<input
													type="text"
										...
										<div className="col-md-12">
											<div className="form-group">
												<label className="form-label fw-semibold">
													Courses Attended<span style={{color:"red",fontSize:"1.3rem"}}>*</span>
												</label>
												<input
													type="text"
													className="form-control"
										...
										<div className="col-md-12">
											<div className="form-group">
												<label className="form-label fw-semibold">
													Text<span style={{color:"red",fontSize:"1.3rem"}}>*</span>
												</label>
												<textarea
													className="form-control"
													name="description"
